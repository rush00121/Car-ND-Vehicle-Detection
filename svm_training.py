...
def gethotwindows(image):
    ...
    slide_window(image, x_start_stop=x_start_stop, y_start_stop=[int(image.shape[0]/2)+50,int(image.shape[0]/2+100)],
                             xy_window=(100, 100), xy_overlap=(0.8, 0.8),window_list=windows)
    slide_window(image, x_start_stop=x_start_stop, y_start_stop=[int(image.shape[0]/2+100), image.shape[0]],
                            xy_window=(200, 200), xy_overlap=(0.8, 0.8),window_list=windows)
...
def detect_vehicles(image,showheatmap=False):
